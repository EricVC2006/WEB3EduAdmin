  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <h1 className="text-3xl sm:text-5xl font-[family-name:var(--font-geist-sans)] text-center sm:text-left font-semibold tracking-[-.02em]">
          Criar conta de <a href="https://nextjs.org">administrador</a>
        </h1>
      ...
      <footer className="row-start-3 flex gap-[24px] flex-wrap items-center justify-center">
            ...
            target="_blank"
            rel="noopener noreferrer">
          <img src="/Web3EduBrasil_logo.png" alt="web3" width={50} height={40} />
            Ir para o site de home do web3edu
          </a>
        <a
